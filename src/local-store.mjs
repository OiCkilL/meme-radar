...
export class RadarControls {
  constructor(dir, chains, initialChain) {
    ...
    if (!Object.prototype.hasOwnProperty.call(loaded, 'throughputEnabled')
      && (process.env.THROUGHPUT_MODE === '1' || process.env.THROUGHPUT_MODE === 'true')) {
